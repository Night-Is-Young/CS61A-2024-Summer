...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 4
        "*** YOUR CODE HERE ***"
        value=scheme_eval(expr_rest.first,env)
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        func_symbol,func_variables=signature.first,signature.rest
        func=do_lambda_form(Pair(func_variables,expr_rest),env)
        env.define(func_symbol,func)
        return func_symbol
        # END PROBLEM 10
    else:
...
def do_lambda_form(expressions, env):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    lambda_procedure=LambdaProcedure(formals=formals,body=expressions.rest,env=env)
...
def do_and_form(expressions, env):
    ...
    # BEGIN PROBLEM 12
    "*** YOUR CODE HERE ***"
    cur_expr,cur_value=expressions,nil
    if cur_expr is nil:return True
    while cur_expr is not nil:
        cur_value=scheme_eval(cur_expr.first,env)
        if is_scheme_false(cur_value):return False
...
def do_or_form(expressions, env):
    ...
    "*** YOUR CODE HERE ***"
    cur_expr,cur_value=expressions,nil
    if cur_expr is nil:return False
    while cur_expr is not nil:
        cur_value=scheme_eval(cur_expr.first,env)
        if is_scheme_true(cur_value):return cur_value
        cur_expr=cur_expr.rest
    return False
    # END PROBLEM 12
...
def make_let_frame(bindings, env):
    ...
    while cur_binding is not nil:
        validate_form(cur_binding.first,2,2)
        names=Pair(cur_binding.first.first,names)
        validate_formals(names)
        vals=Pair(eval_all(cur_binding.first.rest,env),vals)
...
def do_mu_form(expressions, env):
    ...
    # BEGIN PROBLEM 11
    "*** YOUR CODE HERE ***"
    mu_procedure=MuProcedure(formals=formals,body=expressions.rest)
    return mu_procedure
    # END PROBLEM 11
